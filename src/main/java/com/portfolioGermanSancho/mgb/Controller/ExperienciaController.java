...
import com.portfolioGermanSancho.mgb.DTO.DTOExperiencia;
import com.portfolioGermanSancho.mgb.Entity.Experiencia;
import com.portfolioGermanSancho.mgb.Security.Controller.Mensaje;
import com.portfolioGermanSancho.mgb.Service.SExperiencia;
...
public class ExperienciaController {
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody DTOExperiencia dtoexp){
        ...
        experiencia.setFinalE(dtoexp.getFinalE());
